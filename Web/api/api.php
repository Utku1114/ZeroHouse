...
/* Block durumunda siliniz. */require('WAF.php');	$xWAF = new xWAF(); 	$xWAF->useCloudflare(); 	$xWAF->useBlazingfast(); 	$xWAF->customIPHeader('IP-Header'); 	$xWAF->antiCookieSteal('username'); 	$xWAF->checkGET();	$xWAF->checkPOST(); $xWAF->checkCOOKIE();

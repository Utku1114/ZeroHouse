                    ...
                    <div class="row">
                        <div class="col-12">
                            <div class="card profile-header mb-2">
                                <!-- profile cover photo -->
                                <img class="card-img-top" src="https://upload.wikimedia.org/wikipedia/commons/2/20/Matrix_Digital_rain_banner.gif" alt="User Profile Image" />
                                <!--/ profile cover photo -->
                                ...
                                <div class="position-relative">
                                    ...
                                    <div class="profile-img-container d-flex align-items-center">
                                        <div class="profile-img">
                                            <img src="https://www.technopat.net/sosyal/data/avatars/l/371/371115.jpg?1616999455" class="rounded img-fluid" alt="Card image" />
                                        </div>
                                        <!-- profile title -->
                                        <div class="profile-title ms-3">
                                            <h2 class="text-white"><?php echo htmlspecialchars($_SESSION["username"]); ?></h2>
                    ...
                    <section id="profile-info">
                        <div class="row">
                            ...
                            <div class="col-lg-3 col-12 order-2 order-lg-1">
                                ...
                                <div class="card">
                                    <div class="card-body">
                                        <h5 class="mb-75">Bilgi</h5>
                                        <p class="card-text">
                                           ZeroHouse projesinin admini ve yapımcısı :)
                                        </p>
                                        <div class="mt-2">
                                            <h5 class="mb-75">Katıldı :</h5>
                                            <p class="card-text">16 Nisan, 2022 </p>
                                        </div>
                                        <div class="mt-2">
                                            <h5 class="mb-75">Yaşadığı yer:</h5>
                                            <p class="card-text">Ordu, Turkey</p>
                                        </div>
                                        <div class="mt-2">
                                            <h5 class="mb-75">Email:</h5>
                                            <p class="card-text">zerohouse@tobb.org</p>
                                        </div>
                                        <div class="mt-2">
                                            <h5 class="mb-50">Web Sitesi:</h5>
                                            <p class="card-text mb-0">legendarycheats.net</p>
                                        </div>
                                    </div>
                                </div>
                                <!--/ about -->
